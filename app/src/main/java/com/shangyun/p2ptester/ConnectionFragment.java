...
import com.shangyun.p2ptester.ConnectionFragment;
import com.shangyun.p2ptester.MyPopupWindows;
import com.shangyun.p2ptester.R.id;
import com.shangyun.p2ptester.task.BaseTask;
import com.shangyun.p2ptester.task.ConnectTask;
import com.shangyun.p2ptester.ConnectionFragment.AccountObject;
...
public class ConnectionFragment extends Fragment implements OnClickListener {
    ...
    public void initViews() {
        ...
        //初始化参数信息
        editDID.setText("PPCS-016834-JGDBD");
        editWakeupkey.setText("0123456789ABCDEF");
        editip1.setText("222.209.16.126");
