...
public class st_PPCS_NetInfo {
	...
	public int getbFlagInternet() { return (int)(bFlagInternet&0xFF);		}
	public int getbFlagHostResolved() { return (int)(bFlagHostResolved&0xFF);		}
	public int getbFlagServerHello() { return (int)(bFlagServerHello&0xFF);		}
	public int getNAT_Type() { return (int)(NAT_Type&0xFF);		}
